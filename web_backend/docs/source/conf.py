...
htmlhelp_basename = 'WebBackenddoc'
...
latex_documents = [
    (master_doc, 'WebBackend.tex', 'Web Backend Documentation',
...
man_pages = [
    (master_doc, 'webbackend', 'Web Backend Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'WebBackend', 'Web Backend Documentation',
     author, 'WebBackend', 'One line description of project.',
     'Miscellaneous'),
]
